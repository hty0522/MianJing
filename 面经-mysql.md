...
作者：阿丸
链接：https://www.zhihu.com/question/434734816/answer/1626229650
来源：知乎
...
**意向锁是一种表锁，InnoDB支持多粒度锁，它允许行级锁和表级锁共存，当某一事物想对某个表加写锁时，对表的每一行都进行检测是非常低效的，而通过意向锁，只需检查是否有其他事务给这个表加了读、写、意向读、意向写锁即可**
